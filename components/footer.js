            ...
            <div>
              ...
              <ul style="list-style: none; padding: 0;">
                <li style="margin-bottom: 12px;">
                  <a href="mailto:info@ayigh.africa" style="color: #94a3b8; text-decoration: none; transition: color 0.3s; display: inline-flex; align-items: center; gap: 8px;" onmouseover="this.style.color='#50C878'" onmouseout="this.style.color='#94a3b8'">
                    📧 info@ayigh.africa
                  </a>
                </li>
                <li style="margin-bottom: 12px;">
